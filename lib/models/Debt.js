...
const InstallmentSchema = new mongoose.Schema({
  ...
  carriedInterest: { type: Number, default: 0 }, // juros carregados de parcela anterior (skip/parcial)
  creditPaid:        { type: Boolean, default: false }, // parcela quitada por crédito de overpayment (não soma no total recebido)
  lateInterestPaid:  { type: Number,  default: 0 },    // juros de atraso efetivamente recebidos no pagamento
  manualInterest:    { type: Number,  default: 0 },    // juros manuais adicionados pelo operador (R$ extras)
}, { _id: false });
